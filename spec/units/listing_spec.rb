...
describe Listing do
  ...
  describe 'self.create' do
    it 'adds a listing to the database' do
      ...
      Listing.create(title: 'testtitle', description: 'test description', price: '100', available_night: '20210101')
  ...
  describe 'self.all' do
    it 'returns an array of listing objects of all listings in the database' do
      conn = PG.connect(dbname: 'abodenb_test')
      Listing.create(title: 'testtitle', description: 'test description', price: '100', available_night: '20210101')
      Listing.create(title: 'testtitle2', description: 'test description', price: '100', available_night: '20210101')
  ...
  describe '#title' do
    it 'returns the title of the listing' do
      pg_instance_returned = Listing.create(title: 'testtitle', description: 'test description', price: '100', available_night: '20210101')
